var s_tc_ControlCenterHostingVersion10=new TagContainer('ControlCenterHostingVersion10');
...
var s_account="iagcchostdev";
if(UNOUNO.params.siteModus === 'live' && UNOUNO.params.isWaterloo === 'no') s_account="iagcchostlive,iaggloballive";
...
s.linkInternalFilters="javascript:,ionos.de,ionos.at,ionos.co.uk,ionos.com,ionos.it,ionos.fr,ionos.ca,ionos.es,ionos.eu,web.de"
...
var hn = window.location.hostname || '', start, tld;
start = hn.indexOf('.ionos.');
start = start + 7;
tld = hn.substr(start);
s.trackingServer='metrics.ionos.' + tld;

s.setTagContainer("ControlCenterHostingVersion10")
